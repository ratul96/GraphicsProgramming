...
public:
	...
	void SetCubeMatrices(glm::mat4 viewMatrix, glm::mat4 projMatrix);
...
protected:
	...
	int _shaderTexDiffuseLocation;
	int _shaderTexSpecularLocation;
	int _shaderCubeLocation;
